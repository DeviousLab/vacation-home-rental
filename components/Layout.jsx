  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="title"
          content="Find your next vacation home with us"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className="min-h-screen flex flex-col bg-gray-200">
        <header className="h-16 w-full shadow-md bg-slate-700">
              ...
              <Link href="/">
                <a className="flex items-center space-x-1">
                  ...
                  <span className="text-xl font-semibold tracking-wide text-white">
                    Vacation<span className="text-blue-600">Homes</span>
                  </span>
                </a>
              </Link>
              <div className="flex items-center space-x-4">
                <Link href="/create">
                  <a className="hidden text-white sm:block hover:bg-gray-200 hover:text-black transition px-3 py-1 rounded-md">
                    List your home
                  </a>
                </Link>
                {isLoadingUser ? (
